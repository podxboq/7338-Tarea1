\section{Emmy Noether}\label{sec:emmy-noether}
...
Procedente de una familia de confesión Judía, su padre \define{Max Noether}{Max Noether}, fue un reconocido matemático autodidacta que consiguió un puesto en la Universidad de Erlangen.
...
Durante este periodo fue muy relevante el cambio de la dirección de Paul Gordan por la de \define{Ernst Fischer}{Ernst Fischer}, dada la reticencia de Gordan a los métodos de generalización de \define{Hilbert}{David Hilbert}, a los que denominó ``Teología'' con cierta sorna, lo que permitió a Noether disponer de más herramientas para sus investigaciones~\cite{Weyl}.
...
Tuvo alumnos que vinieron desde diversas partes del mundo para estudiar con ella, a los que se conocía como los ``los chicos de Noether''~\cite{Carrasco}).
