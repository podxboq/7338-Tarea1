...
En la mecánica lagrangiana, para cada partícula del sistema se consideran los valores que definen su posición, dichos valores reciben el nombre de \define{coordenadas generalizadas}{Coordenadas generalizadas}~\autocite{GTP}.
